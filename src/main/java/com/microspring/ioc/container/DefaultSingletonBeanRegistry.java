...
public class DefaultSingletonBeanRegistry implements SingletonBeanRegistry {
    ...
    public Map<String, Object> getEarlyExposedSingletonMap() {
        return earlyExposedSingletonMap;
    }

    public Map<String, BeanObjectFactory<?>> getSingletonsFactory() {
        return singletonsFactory;
    }
