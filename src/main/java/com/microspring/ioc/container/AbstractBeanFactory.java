...
import com.microspring.ioc.callback.aware.ApplicationContextAware;
import com.microspring.ioc.callback.aware.Aware;
import com.microspring.ioc.callback.processor.Initializer;
import com.microspring.ioc.context.ApplicationContext;
import com.microspring.cglib.proxy.MethodInterceptor;
import com.microspring.aop.aspect.AutoProxyName;
import com.microspring.aop.autoproxy.ProxyCreator;
...
import com.microspring.ioc.callback.processor.BeanPostProcessor;
import com.microspring.ioc.callback.processor.InstantiationAwareBeanPostProcessor;
...
//        }
    ...
    private boolean resolvePostPorcessorAfterInstantiation(Object beanObject, BeanDefinition beanDefinition) {
        ...
        for (BeanPostProcessor beanPostProcessor : beanPostProcessors) {
            if (beanPostProcessor instanceof InstantiationAwareBeanPostProcessor) {
                needToPopulate =
                        ((InstantiationAwareBeanPostProcessor) beanPostProcessor).postProcessAfterInstantiation(beanObject, beanDefinition.getBeanName());
                if (!needToPopulate)
                    break;
            }
        }
     ...
     * @return
     */
    private Object instantiation(BeanDefinition beanDefinition) throws NoSuchMethodException, IllegalAccessException,
     ...
     */
    private Object instantiationWithoutArgs(BeanDefinition beanDefinition) throws NoSuchMethodException,
