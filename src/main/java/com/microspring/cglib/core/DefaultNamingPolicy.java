 ...
 * <p><code>com.microspring.cglib.Foo$$EnhancerByCGLIB$$38272841</code><p>
...
public class DefaultNamingPolicy implements NamingPolicy {
     ...
     */
    private final static boolean STRESS_HASH_CODE = Boolean.getBoolean("com.microspring.cglib.test.stressHashCodes");
    
    public String getClassName(String prefix, String source, Object key, Predicate names) {
        if (prefix == null) {
            prefix = "com.microspring.cglib.empty.Object";
