...
public class InterceptFieldTransformer extends ClassEmitterTransformer {
    ...
    private static final Type CALLBACK =
      TypeUtils.parseType("com.microspring.cglib.transform.impl.InterceptFieldCallback");
    private static final Type ENABLED =
      TypeUtils.parseType("com.microspring.cglib.transform.impl.InterceptFieldEnabled");
