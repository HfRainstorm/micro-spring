...
import com.microspring.cglib.core.ClassInfo;
...
implements CallbackGenerator
{
    ...
    private static final Type REFLECT_UTILS =
      TypeUtils.parseType("com.microspring.cglib.core.ReflectUtils");
    private static final Type METHOD_PROXY =
      TypeUtils.parseType("com.microspring.cglib.proxy.MethodProxy");
    private static final Type METHOD_INTERCEPTOR =
      TypeUtils.parseType("com.microspring.cglib.proxy.MethodInterceptor");
